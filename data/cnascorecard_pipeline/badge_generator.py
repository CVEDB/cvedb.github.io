...
def generate_badge_svg(
    cna_name: str, score: float, rank: int, badge_style: str = "rank", categories: dict[str, float] | None = None
) -> str:
    """
...
def _generate_rank_badge(rank: int, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="28" role="img" aria-label="cvedb.github.io Rank: {rank_str}">
    <title>cvedb.github.io Rank: {rank_str}</title>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="195" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">cvedb.github.io Rank</text>
        <text x="735" y="185" transform="scale(.1)" fill="#fff" textLength="1350">cvedb.github.io Rank</text>
...
def _generate_score_badge(score: float, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="28" role="img" aria-label="cvedb.github.io Score: {score_str}">
    <title>cvedb.github.io Score: {score_str}</title>
    <linearGradient id="s" x2="0" y2="100%">
        <stop offset="0" stop-color="#bbb" stop-opacity=".1"/>
        <stop offset="1" stop-opacity=".1"/>
    </linearGradient>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="195" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">cvedb.github.io Score</text>
        <text x="735" y="185" transform="scale(.1)" fill="#fff" textLength="1350">cvedb.github.io Score</text>
...
def _generate_combined_badge(score: float, rank: int, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="28" role="img" aria-label="cvedb.github.io: {badge_str}">
    <title>cvedb.github.io: {badge_str}</title>
    <linearGradient id="s" x2="0" y2="100%">
        <stop offset="0" stop-color="#bbb" stop-opacity=".1"/>
        <stop offset="1" stop-opacity=".1"/>
    </linearGradient>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="195" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">cvedb.github.io</text>
        <text x="735" y="185" transform="scale(.1)" fill="#fff" textLength="1350">cvedb.github.io</text>
...
def _generate_detailed_badge(categories: dict[str, float]) -> str:
    ...
    title_text = f"cvedb.github.io: {title_parts}"
...
{segments_str}
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="{label_center_x}" y="195" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1050">cvedb.github.io</text>
        <text x="{label_center_x}" y="185" transform="scale(.1)" fill="#fff" textLength="1050">cvedb.github.io</text>
{texts_str}
    </g>
</svg>'''
...
def _generate_metric_badge(abbrev: str, pct: float) -> str:
    ...
    label_text = f"cvedb.github.io {abbrev}"
    pct_str = f"{pct:.0f}%"
...
def generate_cna_badges(cna_outputs: dict[str, dict], output_dir: Path) -> dict[str, str]:
    """
...
def generate_badge_documentation(output_dir: Path, base_url: str = "https://cvedb.github.io/scorecard") -> str:
    """
...
Visit [CNA Scorecard]({base_url}) or open an issue on [GitHub](https://github.com/cvedb/cvedb.github.io).
"""
