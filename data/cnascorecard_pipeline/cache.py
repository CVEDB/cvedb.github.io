...
class ScoreCache:
    ...
    def get(self, cve_id: str, cve_data: dict[str, Any]) -> dict[str, Any] | None:
        """
    ...
    def get_batch(self, cve_records: list[dict[str, Any]]) -> tuple[dict[str, dict[str, Any]], list[dict[str, Any]]]:
        """
    ...
    def set_batch(self, scores: list[dict[str, Any]], cve_lookup: dict[str, dict[str, Any]]) -> None:
        """
...
_global_cache: ScoreCache | None = None


def get_cache(cache_dir: Path | None = None) -> ScoreCache:
    """
...
def score_with_cache(
    cve_records: list[dict[str, Any]], scoring_func, cache: ScoreCache | None = None
) -> list[dict[str, Any]]:
    """
