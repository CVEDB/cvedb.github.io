...
WEB_DATA_DIR = PROJECT_ROOT / "web" / "scorecard" / "data"
...
class ScoringConfig:
    ...
    def _load_scoring_rules(self) -> dict[str, Any]:
        ...
        try:
            ...
            raise FileNotFoundError(f"Scoring rules file not found: {RULES_FILE}") from None
        except json.JSONDecodeError as e:
            raise ValueError(f"Invalid JSON in scoring rules file: {e}") from e

    def _load_valid_cwe_ids(self) -> set:
        """Load valid CWE IDs from cwe_ids.json."""
        try:
            with open(CWE_IDS_FILE) as f:
                return set(json.load(f))
        except FileNotFoundError:
            raise FileNotFoundError(f"CWE IDs file not found: {CWE_IDS_FILE}") from None
        except json.JSONDecodeError as e:
            raise ValueError(f"Invalid JSON in CWE IDs file: {e}") from e
...
CANONICAL_FIELDS = [
    ...
    },
    {
        ...
        "importance": "High",
        "description": "Patch Info URLs and documentation",
        "cna_scorecard_category": "foundationalCompleteness",
    },
    {
        "field": "problemTypes.cwe",
        "importance": "High",
        "description": "Common Weakness Enumeration identifiers",
        "cna_scorecard_category": "rootCauseAnalysis",
    },
    {
        "field": "metrics.cvssV3_1",
        "importance": "High",
        "description": "CVSS v3.1 metrics",
        "cna_scorecard_category": "severityAndImpactContext",
    },
    {
        "field": "metrics.cvssV3_0",
        "importance": "High",
        "description": "CVSS v3.0 metrics",
        "cna_scorecard_category": "severityAndImpactContext",
    },
    {
        "field": "metrics.cvssV4_0",
        "importance": "High",
    ...
    },
    {
        ...
        "cna_scorecard_category": "softwareIdentification",
    },
    {
        "field": "references.patch",
        "importance": "High",
        "description": "Patch references",
        "cna_scorecard_category": "patchinfo",
    },
    ...
    {"field": "problemTypes.type", "importance": "Medium", "description": "Problem type classification"},
    {
        ...
        "importance": "High",
        "description": "Problem type information (CWE, etc.)",
    },
    ...
    {
        "field": "containers.cna.datePublic",
        "importance": "Low",
        "description": "Date the vulnerability was disclosed publicly",
    },
...
LOGGING_CONFIG = {
    ...
    "handlers": {
        ...
        "file": {"level": "DEBUG", "class": "logging.FileHandler", "filename": "pipeline.log", "formatter": "detailed"},
    },
    "loggers": {"cnascorecard": {"handlers": ["console", "file"], "level": "DEBUG", "propagate": False}},
...
def get_config() -> dict[str, Any]:
    ...
    return {
        ...
        "website": {
            "base_url": "https://cvedb.github.io/scorecard",
        },
        "fields": {
