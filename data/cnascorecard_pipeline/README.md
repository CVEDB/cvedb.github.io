...
CONFIG = {
    "directories": {
        "cve_data": "../cve_data",
        "web_data": "../web/scorecard/data",
        "completeness": "../web/scorecard/data/completeness",
        "cna_data": "../web/scorecard/data/cna",
    },
    "scoring": {"rules_file": "rules.json", "cwe_ids_file": "cwe_ids.json"},
    "analysis": {"default_period_months": 6, "trend_periods": 3},
}
```
...
### Individual CNA Files (`/web/scorecard/data/cna/{cna_name}.json`)
...
### Completeness Files (`/web/scorecard/data/completeness/`)
