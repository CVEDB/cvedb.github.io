...
from .utils import ensure_directory_exists, write_json_file


logger = logging.getLogger("cnascorecard.chunking")


def write_chunked_cna_data(cna_list: list[dict[str, Any]], output_dir: Path, chunk_size: int = 50) -> dict[str, Any]:
    """
...
def write_chunked_completeness_data(
    completeness_list: list[dict[str, Any]], output_dir: Path, chunk_size: int = 100
) -> dict[str, Any]:
    """
...
def generate_search_index(cna_list: list[dict[str, Any]], output_dir: Path) -> dict[str, Any]:
    """
...
def generate_summary_stats(cna_list: list[dict[str, Any]], output_dir: Path) -> dict[str, Any]:
    """
