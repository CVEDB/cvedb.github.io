...
def _generate_rank_badge(rank: int, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="20" role="img" aria-label="CNAScorecard Rank: {rank_str}">
    <title>CNAScorecard Rank: {rank_str}</title>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">CNAScorecard Rank</text>
        <text x="735" y="140" transform="scale(.1)" fill="#fff" textLength="1350">CNAScorecard Rank</text>
...
def _generate_score_badge(score: float, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="20" role="img" aria-label="CNAScorecard Score: {score_str}">
    <title>CNAScorecard Score: {score_str}</title>
    <linearGradient id="s" x2="0" y2="100%">
        <stop offset="0" stop-color="#bbb" stop-opacity=".1"/>
        <stop offset="1" stop-opacity=".1"/>
    </linearGradient>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">CNAScorecard Score</text>
        <text x="735" y="140" transform="scale(.1)" fill="#fff" textLength="1350">CNAScorecard Score</text>
...
def _generate_combined_badge(score: float, rank: int, color: str) -> str:
    ...
    return f'''<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{int(badge_width)}" height="20" role="img" aria-label="CNAScorecard: {badge_str}">
    <title>CNAScorecard: {badge_str}</title>
    <linearGradient id="s" x2="0" y2="100%">
        <stop offset="0" stop-color="#bbb" stop-opacity=".1"/>
        <stop offset="1" stop-opacity=".1"/>
    </linearGradient>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        <text aria-hidden="true" x="735" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="1350">CNAScorecard</text>
        <text x="735" y="140" transform="scale(.1)" fill="#fff" textLength="1350">CNAScorecard</text>
...
def generate_badge_documentation(output_dir: Path, base_url: str = "https://cvedb.github.io") -> str:
    """
