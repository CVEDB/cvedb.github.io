...
* A program for CNAs to submit CVE Records using JSON is available on the [CVEDB](https://github.com/CVEDB/cvelist) website on GitHub.com. All CNAs are eligible to participate.
...
* [CVE JSON Schema Repository](https://github.com/CVEDB/automation-working-group/tree/master/cve_json_schema)
  <ul>
    <li><a href="https://github.com/CVEDB/automation-working-group/blob/master/cve_json_schema/DRAFT-JSON-file-format-v4.md">CVE ID JSON File Format 4.0 (Draft)</a></li>
    <li><a href="https://github.com/CVEDB/automation-working-group/blob/master/cve_json_schema/CVE_JSON_4.0_min_public.schema">Schema for validating a JSON file against the minimal CVE structure</a></li>
  </ul>
* [CVE Automation WG Tools](https://github.com/CVEDB/automation-working-group/tree/master/tools)
  <ul>
    <li><a href="https://github.com/CVEDB/automation-working-group/blob/master/tools/cmdlinejsonvalidator.py">Python script to validate JSON files (requires a valid schema file)</a></li>
  </ul>
