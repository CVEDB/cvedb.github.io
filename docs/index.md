...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       <ul>
         <li markdown="span">[CVE List GitHub Automation Pilot](https://github.com/CVEDB/cvelist)</li>
         <li markdown="span">[CVE JSON Schema Project](https://github.com/CVEDB/automation-working-group/tree/master/cve_json_schema)</li>
         <li markdown="span">[CNA Registry Project](https://github.com/CVEDB/CNA-registry-project-AWG)</li>
         <li markdown="span">[AWG Charter](https://github.com/CVEDB/automation-working-group/blob/master/AWG_Charter.md)</li>
         <li markdown="span">[AWG GitHub Repository](https://github.com/CVEDB/automation-working-group)</li>
         <br>
         <li markdown="span">[CVE ID Allocation Service](https://github.com/CVEDB/CVE-Services)</li>
         <li markdown="span">[CVE ID Allocation Service Specification](https://github.com/CVEDB/CVE-ID-Allocation-Service)</li>
         <br>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul>
          ...
          <li markdown="span">[SPWG GitHub Repository](https://github.com/CVEDB/strategic-planning-working-group)</li>
          <li markdown="span">[Request information or Join](https://cveform.mitre.org/) (via CVE Request Web Form - select “Other”)</li>
        </ul>
      </div>
    </div>
 ...
 <div class="col-md-6">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       <ul>
         <li markdown="span">[QWG Charter](https://github.com/CVEDB/quality-workgroup/blob/main/README.md)</li>
         <li markdown="span">[Request information or Join](https://cveform.mitre.org/) (via CVE Request Web Form - select “Other”)</li>
       </ul>
      </div>
    </div>
