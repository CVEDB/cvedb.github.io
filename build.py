...
class CVESiteBuilder:
    """Main class for building the CVE DB static site"""
    ...
    def __init__(self, quiet=False):
        ...
        if not self.quiet:
            print(f"🚀 CVE DB Build System Initialized")
    ...
    def generate_html_pages(self):
        ...
        pages = [
            ...
            {'template': 'about.html', 'output': 'about.html', 'title': 'About CVE DB'}
        ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='CVE DB Static Site Generator',
