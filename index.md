...
<div class="jumbotron">
  ...
  <br>
  <h3>View <a href="https://cvedb.github.io/automation-transition">transition details</a> for the upcoming new version releases of CVE JSON v5.0 and CVE Services v2.1.</h3>
  <br>
  <p><a class="btn btn-primary btn-lg" role="button" href="https://cvedb.github.io/automation-transition">CVE Services transition »</a> &nbsp; &nbsp;     
  <a class="btn btn-primary btn-lg" role="button" href="https://cvedb.github.io/automation-transition">CVE JSON 5.0 transition »</a></p>
</div>
