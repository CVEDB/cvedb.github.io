...
import pytest
from cnascorecard_pipeline.cache import ScoreCache, get_cache, reset_cache
...
class TestScoreCacheGetSet:
    ...
    def sample_cve_data(self):
        ...
        return {"cveMetadata": {"cveId": "CVE-2024-0001"}, "containers": {"cna": {"descriptions": [{"value": "test"}]}}}

    @pytest.fixture
    def sample_score(self):
        """Sample score data for testing."""
        return {"cveId": "CVE-2024-0001", "totalScore": 75, "scoreBreakdown": {"foundational": 40, "rootCause": 10}}
...
class TestScoreCacheBatch:
    ...
    def test_get_batch_handles_missing_cve_id(self, cache):
        ...
        records = [{"data": "no_cve_id"}, {"cveMetadata": {"cveId": "CVE-2024-0001"}, "data": "has_id"}]
    ...
    def test_set_batch(self, cache, sample_cve_records):
        ...
        scores = [{"cveId": "CVE-2024-0001", "score": 50}, {"cveId": "CVE-2024-0002", "score": 60}]
        cve_lookup = {"CVE-2024-0001": sample_cve_records[0], "CVE-2024-0002": sample_cve_records[1]}
