...
from cnascorecard_pipeline.scoring import (
...
class TestScoringFixtures:
        ...
        return {
            ...
            "containers": {
                "cna": {
                    ...
                    "descriptions": [
                        {"lang": "en", "value": "A vulnerability in the test application allows remote code execution."}
                    ],
                    "affected": [
                        {
                            "vendor": "TestVendor",
                    ...
                    "problemTypes": [{"descriptions": [{"cweId": "CWE-78", "description": "OS Command Injection"}]}],
                    "metrics": [
                        {
                            "cvssV3_1": {
    ...
    def sample_cve_minimal(self) -> dict[str, Any]:
        ...
        return {
            ...
            "containers": {"cna": {"providerMetadata": {"shortName": "MinimalCNA"}}},
        }
    ...
    def sample_cve_partial(self) -> dict[str, Any]:
        ...
        return {
            ...
            "containers": {
                "cna": {
                    "providerMetadata": {"shortName": "PartialCNA"},
                    "descriptions": [{"lang": "en", "value": "A vulnerability exists."}],
                    "affected": [{"vendor": "TestVendor", "product": "TestProduct"}],
                    "references": [{"url": "https://example.com/info", "tags": ["vendor-advisory"]}],
                }
            },
        }
...
class TestScoreCveRecord(TestScoringFixtures):
    ...
    def test_score_cve_missing_metadata(self):
        ...
        cve_no_metadata = {"containers": {"cna": {"providerMetadata": {"shortName": "TestCNA"}}}}
...
class TestRootCauseAnalysis(TestScoringFixtures):
    ...
    def test_find_valid_cwe_success(self):
        ...
        problem_types = [{"descriptions": [{"cweId": "CWE-78", "description": "OS Command Injection"}]}]
    ...
    def test_find_valid_cwe_failure(self):
        ...
        problem_types = [{"descriptions": [{"description": "Some vulnerability"}]}]
...
class TestSeverityContext(TestScoringFixtures):
    ...
    def test_has_cvss_metrics_detection(self):
        ...
        metrics_with_cvss = [{"cvssV3_1": {"baseScore": 9.8}}]
        metrics_without_cvss = [{"other": "data"}]
    ...
    def test_has_valid_cvss_vector_detection(self):
        ...
        metrics_with_vector = [{"cvssV3_1": {"vectorString": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H"}}]
        metrics_without_vector = [{"cvssV3_1": {"baseScore": 9.8}}]
...
class TestSoftwareIdentification(TestScoringFixtures):
    ...
    def test_has_cpe_identifiers_detection(self):
        ...
        affected_with_cpes = [{"cpes": ["cpe:2.3:a:vendor:product:1.0:*:*:*:*:*:*:*"]}]
        affected_without_cpes = [{"vendor": "TestVendor"}]
...
class TestActionableIntelligence(TestScoringFixtures):
    ...
    def test_references_without_patch_tags(self):
        ...
        cve = {}
        cna = {"references": [{"url": "https://example.com/info", "tags": ["vendor-advisory"]}]}
        score = _calculate_actionable_intelligence(cve, cna)
        assert score == 0

    def test_has_patch_references_detection(self):
        """Test patch reference detection."""
        refs_with_patch = [{"tags": ["patch", "vendor-advisory"]}]
        refs_without_patch = [{"tags": ["vendor-advisory"]}]
...
class TestScoringConfiguration:
    ...
    def test_scoring_config_usage(self):
        ...
        cve = {}
        cna = {"descriptions": ["test"], "affected": ["test"], "references": ["test"]}
