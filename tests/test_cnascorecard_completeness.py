...
import pytest
from cnascorecard_pipeline.completeness import (
    _custom_check,
    _get_nested_value,
    _get_schema_fields,
...
class TestGetNestedValue:
    ...
    def test_cve_metadata_path(self):
        ...
        cve = {"cveMetadata": {"cveId": "CVE-2024-1234", "assignerOrgId": "org-123"}}
...
class TestCustomCheckDescriptions:
    ...
    def test_multiple_languages_true(self):
        ...
        data = [{"lang": "en", "value": "English"}, {"lang": "es", "value": "Spanish"}]
        ...
        return [
            {
                "dataType": "CVE_RECORD",
                "dataVersion": "5.1",
                "cveMetadata": {"cveId": "CVE-2024-0001", "assignerOrgId": "org-1"},
                "containers": {
                    "cna": {
            ...
            },
            {
                "dataType": "CVE_RECORD",
                "dataVersion": "5.1",
                "cveMetadata": {"cveId": "CVE-2024-0002", "assignerOrgId": "org-2"},
                "containers": {
                    "cna": {"descriptions": [{"lang": "en", "value": "Test 2"}], "affected": [{"vendor": "Vendor2"}]}
                },
            },
        ]
...
class TestComputeIndividualCNAFieldUtilization:
    ...
    def test_basic_individual_utilization(self, sample_cve_records_with_shortname):
        ...
        result = compute_individual_cna_field_utilization(sample_cve_records_with_shortname, field_list)
    ...
    def test_records_without_shortname(self):
        ...
        records = [
            {
                "cveMetadata": {"cveId": "CVE-2024-0001"},
                "containers": {"cna": {"descriptions": [{"lang": "en", "value": "No shortName"}]}},
            }
        ]
