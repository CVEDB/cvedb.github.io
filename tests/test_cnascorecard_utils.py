...
import pytest
from cnascorecard_pipeline.utils import (
    ProgressTracker,
...
class TestExtractCnaShortName:
    ...
    def test_extracts_from_provider_metadata(self):
        ...
        cve = {"containers": {"cna": {"providerMetadata": {"shortName": "microsoft"}}}}
    ...
    def test_prefers_provider_metadata(self):
        ...
        cve = {
            "cveMetadata": {"assignerShortName": "fallback"},
            "containers": {"cna": {"providerMetadata": {"shortName": "preferred"}}},
        }
        assert extract_cna_short_name(cve) == "preferred"

    def test_returns_none_when_missing(self):
        """Should return None when no short name available."""
        cve = {"cveMetadata": {}, "containers": {"cna": {}}}
